# UnlockSaaS Video Sales Letter Script
...
## Cold open (10s) — pattern interrupt

(Maryan, on camera, plain background, no lower-thirds, no music)

> "If you shipped a product and your Stripe line is flat, this is a video for you. Three minutes. I want to show you the one piece of work nobody told you to do — and the only piece of software I've found that does not let you skip it."

---

## WHO (45s) — the credibility frame, in reverse

> "I'm not a developer. I have never written a line of production code. In 2026, Lovable and Claude opened the door, and I shipped real AI products in weeks. The shipping part felt like magic. What came after did not."
...
## WHAT (45s) — the Big Domino, said out loud

> "Here is the one belief I'm going to ask you to accept for the next four minutes. Your first paying customer is reachable in 60 days — through software. Not through more building. Not through more traffic. Through a piece of work nobody taught you to do, in a fixed order, with refusals built into the engine when you try to skip steps."

> "If you accept that one sentence, everything else I'm about to show you reorganizes around it. If you reject it, close this tab. I am not interested in arguing it. I'm interested in showing you why it's true."
...
> "On the third one — the guarantee is enforced by code. At day 60 the tool reads your connected Stripe account. If you completed the in-product work and your line is flat, the refund fires. There is no email-the-founder. There is no please-describe-your-experience. The maximum exposure is $98."

---

## HOW (60s) — the offer, signposted
...
## Close (30s) — the stake, no fake scarcity
...
**SCRIPT LOCKED.** Awaiting recording (founder open item). Recommend single-day shoot producing all three cut versions from one take.
