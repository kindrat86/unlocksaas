...
function email3(ctx: RenderContext): RenderedEmail {
  return render({
    ...
    bodyParagraphs: [
      ...
      "Your first paying customer, verified by Stripe within 60 days, or through operator-reviewed App Store Connect or RevenueCat evidence for App Store-distributed products. Or full refund. In writing.",
      "Not your first signup. Not your first 'this is awesome' comment. Connected Stripe resolves automatically; for App Store products we agree the baseline and window in writing first. That is the only proof I will count, and it is the only proof you should count either.",
