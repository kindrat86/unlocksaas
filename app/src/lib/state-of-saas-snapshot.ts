...
function buildSnapshot(): ReadonlyArray<SnapshotObservation> {
  return [
    ...
    // ---------------------------------------------------------------
    {
      ...
      unit: "terms",
      description:
        "Brunson sales-funnel terms taught on the site, declared as schema.org DefinedTermSet entries with founder-authored definitions. Answer engines and knowledge graphs ingesting DefinedTermSet can treat the publisher as a primary citation source for the term.",
      sourceUrl: `${BASE_URL}/glossary`,
      asOf: SNAPSHOT_LAST_VERIFIED_DATE,
    },
    {
...
> = Object.freeze({
  ...
  "topical-authority":
    "Machine-readable signals declaring what UnlockSaaS is an authority on. Consumed by knowledge-graph crawlers, search retrievers, and answer engines.",
  "entity-graph":
