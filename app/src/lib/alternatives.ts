...
const ALTERNATIVES_LIST: Alternative[] = [
  ...
  },
  {
    ...
    displayName: "Wix",
    creator: "Wix.com Ltd.",
    category: "Website builder and hosting",
    oneLine: "Wix builds the site. Unlock SaaS finds the customers who visit it. Different jobs, different tools.",
    pricingNote: "Wix has a free plan and paid site plans that start around $17/month (verified 2026-08-14). Unlock SaaS is $1 Starter + $49/month Playbook.",
    whatItIs: [
      "A drag-and-drop website builder with hosting and a large template library",
      "A way for a non-technical founder to publish a polished site fast",
      "A platform that bundles domains, hosting, and design in one place",
    ],
    whatItIsNot: [
      "A diagnosis of why a live site still converts at zero",
      "A customer-acquisition playbook tied to your Stripe ledger",
      "A sales-and-outreach motion that runs after the site is live",
    ],
    whoForIt: "Founders who need a professional website or landing page and want to build it themselves without writing code.",
    whoNotForIt: "Founders whose site is already live and polished but still has no paying customers.",
    honestVerdict: "Wix is very good at the problem it solves: turning a non-technical founder into someone with a clean, live website in an afternoon. The problem it does not touch is the one most post-launch founders actually have, which is that the site exists, looks fine, and still nobody buys. Unlock SaaS treats that disease directly. The two are commonly used in sequence: build the page on Wix, then run the customer-acquisition playbook on the offer that page presents.",
    faqs: [
      {
        q: "Is Unlock SaaS a Wix alternative?",
        a: "No. Wix builds and hosts the website. Unlock SaaS finds the customers who visit it. They solve different problems and are commonly used together.",
      },
      {
        q: "Can I use Unlock SaaS with a site built on Wix?",
        a: "Yes. The diagnostic takes the URL of your live Wix site and labels what is broken about the offer, not the design. Keep Wix for the site; use Unlock SaaS for the acquisition playbook.",
      },
      {
        q: "Does Unlock SaaS help me design a better Wix site?",
        a: "Not as a design tool. It helps with the offer and messaging on that page, which is usually why a well-designed page still converts at zero. The design was never the missing piece.",
      },
    ],
    capabilities: {
    ...
    tags: ["website-builder", "no-code", "for-pre-launch", "design"],
  ...
  },
  {
    ...
    oneLine: "Shopify builds the store. Unlock SaaS finds the customers for what the store sells. Different layers.",
    pricingNote: "Shopify starts around $39/month on its Basic plan plus transaction fees, with a free trial (verified 2026-08-14). Unlock SaaS is $1 Starter + $49/month Playbook.",
    whatItIs: [
      "A hosted platform for building and running an online store",
      "A payments, inventory, and checkout system in one product",
      "A fast way for a founder to sell physical or digital products online",
    ],
    whatItIsNot: [
      "A way to get someone to pay for what the store sells",
      "A diagnosis of why a product page has no buyers",
      "A refund tied to your Stripe ledger as a performance guarantee",
    ],
    whoForIt: "Founders selling products who want a reliable, hosted store with payments and inventory handled for them.",
    whoNotForIt: "Founders who already have a store and a product but still have no customers.",
    honestVerdict: "Shopify is the default answer for selling products online, and it earns that position. What it does not do is make anyone buy. A store that is live on Shopify and converting at zero has a demand or offer problem, not a platform problem. Unlock SaaS is aimed at the SaaS-shaped version of that problem, but the underlying logic is the same: shipping the store is not the same as getting the first paying customer.",
    faqs: [
      {
        q: "Is Unlock SaaS a Shopify alternative?",
        a: "No. Shopify runs the store and checkout. Unlock SaaS runs the customer-acquisition playbook. One is commerce infrastructure, the other is a go-to-market motion.",
      },
      {
        q: "Can I use Shopify and Unlock SaaS together?",
        a: "They sit on different layers. Shopify powers the storefront; Unlock SaaS diagnoses and fixes the offer and acquisition motion that feeds the store customers. There is no overlap to conflict.",
      },
      {
        q: "Does Unlock SaaS sell products for me?",
        a: "No. It is not a marketplace or a storefront. It is a playbook and diagnostic that verifies results through your Stripe account, not through product sales.",
      },
    ],
    capabilities: {
      tellsYouWhatToDo: false,
    ...
    tags: ["ecommerce", "payments", "for-post-launch", "storefront"],
    lastVerified: "2026-08-14",
  },
  {
    slug: "mailchimp",
    ...
    oneLine: "Mailchimp sends email to a list. Unlock SaaS helps you build the offer that gets a list worth emailing.",
    pricingNote: "Mailchimp has a free tier and paid plans that scale with contact count. Unlock SaaS is $1 Starter + $49/month Playbook.",
    whatItIs: [
      "An email marketing platform for campaigns, automations, and lists",
      "A way to design and send newsletters and drip sequences",
      "A tool for managing subscribers and tracking email engagement",
    ],
    whatItIsNot: [
      "A way to get the first customer who reads the email",
      "A diagnosis of why your offer is not converting",
      "A mechanism that verifies your Stripe revenue and refunds you if nothing sells",
    ],
    whoForIt: "Founders who already have an audience or list and need to communicate with it regularly.",
    whoNotForIt: "Founders who have no list and no customers yet, and need the offer and acquisition motion first.",
    honestVerdict: "Mailchimp is excellent at the problem it solves: sending reliable, well-designed email to a list that already exists. The problem it does not solve is acquiring the customer who should be on that list in the first place. Unlock SaaS targets the earlier step. A founder who has shipped a product and has nobody to email does not need a better email tool; they need a playbook for the first paying customer.",
    faqs: [
      {
        q: "Is Unlock SaaS a Mailchimp alternative?",
        a: "No. Mailchimp is email infrastructure for a list. Unlock SaaS is a customer-acquisition playbook. Different problems, and they are often used in sequence.",
      },
      {
        q: "Can I use Mailchimp and Unlock SaaS together?",
        a: "Yes. Unlock SaaS gets the first paying customer and the offer right, and Mailchimp later nurtures the audience that grows from that. There is no functional overlap.",
      },
      {
        q: "Does Unlock SaaS send email campaigns for me?",
        a: "No. Unlock SaaS is not an email sender. It verifies results through Stripe and runs the acquisition playbook, not the newsletter.",
      },
    ],
    capabilities: {
      tellsYouWhatToDo: false,
    ...
    tags: ["email", "marketing-automation", "for-post-launch", "audience"],
    lastVerified: "2026-08-14",
  },
  {
    slug: "beehiiv",
    ...
    oneLine: "beehiiv grows a newsletter. Unlock SaaS gets a SaaS product its first customer. Different businesses.",
    pricingNote: "beehiiv has a free tier and paid plans starting around $39/month for the Scale plan (verified 2026-08-14). Unlock SaaS is $1 Starter + $49/month Playbook.",
    whatItIs: [
      "A platform for writing, growing, and monetising a newsletter",
      "A growth engine for audience-led media businesses",
      "A way to run a paid or free email publication",
    ],
    whatItIsNot: [
      "A SaaS launch curriculum",
      "A diagnosis of why a product is not selling",
      "A refund tied to your Stripe ledger",
    ],
    whoForIt: "Writers and creators building a newsletter or media audience, especially those monetising through subscriptions.",
    whoNotForIt: "SaaS founders who shipped a product and need their first paying customer, not a publication.",
    honestVerdict: "beehiiv is the right tool for building an audience-first media business, and it is very good at that. It is not a tool for getting a SaaS product its first customer, and it never claims to be. The two can coexist for the same founder: build the newsletter on beehiiv once there is an audience, and use Unlock SaaS for the earlier, harder step of getting a product that people will pay for.",
    faqs: [
      {
        q: "Is Unlock SaaS a beehiiv alternative?",
        a: "No. beehiiv is a newsletter platform for audience businesses. Unlock SaaS is a customer-acquisition playbook for SaaS. Different businesses, different tools.",
      },
      {
        q: "Can I run a beehiiv newsletter and use Unlock SaaS?",
        a: "Yes, this is a common sequence. Use Unlock SaaS to get the first paying SaaS customer and the offer right, then build the newsletter on beehiiv once there is an audience worth writing to.",
      },
      {
        q: "Does Unlock SaaS include newsletter tools?",
        a: "No. Unlock SaaS is a playbook and diagnostic, not a publishing platform. For a newsletter, beehiiv is a reasonable choice; it just will not find your first SaaS customer.",
      },
    ],
    capabilities: {
      tellsYouWhatToDo: false,
    ...
    tags: ["newsletter", "creator-economy", "audience", "for-post-launch"],
    lastVerified: "2026-08-14",
  },
  {
    slug: "kajabi",
    displayName: "Kajabi",
    creator: "Kajabi LLC",
    category: "Course and creator monetisation platform",
    oneLine: "Kajabi sells courses and memberships. Unlock SaaS gets a SaaS product its first customer. Different offers.",
    pricingNote: "Kajabi is a paid platform starting around $149/month with no free tier (verified 2026-08-14). Unlock SaaS is $1 Starter + $49/month Playbook.",
    whatItIs: [
      "An all-in-one platform for selling courses, coaching, and memberships",
      "A way for creators to run a knowledge business with marketing funnels built in",
      "A product for turning expertise into a paid offering",
    ],
    whatItIsNot: [
      "A SaaS launch curriculum",
      "A diagnosis of why your product page converts at zero",
      "A mechanism that verifies Stripe revenue and refunds you if nothing sells",
    ],
    whoForIt: "Creators and educators selling courses, coaching, or memberships and wanting the funnel tooling bundled in.",
    whoNotForIt: "SaaS founders who shipped a product and need customers for it, not a platform for selling expertise.",
    honestVerdict: "Kajabi is a serious, well-built platform for the creator economy, and its price reflects that it bundles a lot of funnel machinery. It is the wrong shape for a SaaS founder whose problem is a flat Stripe line: that founder does not need another course platform, they need an honest diagnosis of why the product is not selling and a playbook to fix it. Unlock SaaS is aimed squarely at that second person.",
    faqs: [
      {
        q: "Is Unlock SaaS a Kajabi alternative?",
        a: "No. Kajabi sells courses, coaching, and memberships. Unlock SaaS gets a SaaS product its first paying customer. Different offers, different tools.",
      },
      {
        q: "Can I use Kajabi and Unlock SaaS together?",
        a: "They serve different businesses. A creator selling knowledge uses Kajabi; a founder selling a SaaS subscription uses Unlock SaaS. There is little overlap.",
      },
      {
        q: "Is Kajabi worth the price for a SaaS founder?",
        a: "Almost never. If you are selling a SaaS product, a course platform is overhead, not the missing piece. The missing piece is usually the offer and the acquisition motion, which is what Unlock SaaS targets.",
      },
    ],
    capabilities: {
      tellsYouWhatToDo: false,
    ...
    homepageUrl: "https://kajabi.com/",
    tags: ["course-platform", "creator-economy", "memberships", "for-post-launch"],
    lastVerified: "2026-08-14",
  },
