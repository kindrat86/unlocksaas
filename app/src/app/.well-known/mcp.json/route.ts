...
const MANIFEST = {
  ...
  tools: [
    ...
    {
      name: "get_dream_100_template",
      summary:
        "Get the canonical Brunson Dream 100 seven-category framework (Communities, Influencers, Podcasts, Newsletters, Products, YouTube, Blogs) with target counts, intent, worked examples, and work-your-way-in vs buy-your-way-in tactic split. Niche-agnostic structural template.",
    },
    {
      name: "get_value_ladder_archetype",
      summary:
        "Get one of the four Brunson funnel archetypes (Lead Funnel Rung 0 free, Unboxing Funnel Rung 1 $1-$50, Presentation Funnel Rung 2 $49-$300/mo, Phone Funnel Rung 3 $2,000+) — pages, Hook/Story/Offer shape, build-order rule, worked example, common indie-scale failure.",
    },
    {
