...
export async function generateMetadata({
  ...
  const title = `${c.a.name} vs ${c.b.name} – Honest Head-to-Head`;
...
export default async function LocalizedCompareDetail({
  params,
}: {
  params: Promise<RouteParams>;
}) {
  ...
  const articleJson = JSON.stringify({
    "@context": "https://schema.org",
    "@type": "Article",
    headline: `${c.a.name} vs ${c.b.name} – Honest Head-to-Head`,
