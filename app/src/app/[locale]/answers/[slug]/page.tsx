        ...
        {row.status === "pending-review" ? (
          ...
          >
            ...
            <p className="leading-relaxed">
              {row.reviewNote ??
                "This locale-prefixed URL is in preview while the localized overlay is being finalized. The complete English answer is published at the canonical link below."}
            </p>
          </div>
        ) : null}
        ...
        <Card>
          <CardContent className="pt-6">
            <p className="text-sm leading-relaxed mb-4">
              Supporting bullets and full context are published in English at
              the canonical URL:
            </p>
            <p>
              <a
            ...
            <p className="text-xs text-muted-foreground mt-4 leading-relaxed">
              ...
              answer renders here in {inLanguage}.
            </p>
          </CardContent>
        </Card>
      </section>
          ...
          <CardContent className="pt-6 pb-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <Button asChild variant="outline">
                <Link href={localizedPath(PATH, locale)}>All answers</Link>
              </Button>
            </div>
          </CardContent>
        </Card>
